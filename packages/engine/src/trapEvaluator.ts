...
import type { PlayTrapCardEvent }               from '@ded/types/socket-events.js';
import type { ActionCard, Character, TrapState, FireplacePortrait } from '@ded/types/entities.js';
import type { CharacterId, CellId, PlayerId, TrapId }  from '@ded/types/enums.js';
import { CHARACTER_IDS }                        from '@ded/types/enums.js';
